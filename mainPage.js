...
function quickData(link,image,title,field1,field2)  {
    return new Data(image,title,'unknown',field1,field2,'unknown','unknown',false,link);
}
...
let MainPageObject = new MainPage(new ModuleRequest(mainPageLink,'get',emptyKeyValue,null),new Extra([new Commands('',emptyKeyValue)],emptyKeyValue),new JavascriptConfig(false,false,''),output);
